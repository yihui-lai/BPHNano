...
CountK0To4MuonBPH = cms.EDFilter(
    "PATCandViewCountFilter",
    minNumber = cms.uint32(0),
    maxNumber = cms.uint32(999999),
    src = cms.InputTag("K0To4Mu:Selected4Leptons")
)

########################### Tables ###########################
K0To4MuTable = cms.EDProducer(
    "SimpleCandidateFlatTableProducer",
    src = cms.InputTag("K0To4Mu:Selected4Leptons"),
    cut = cms.string(""),
    name = cms.string("K0To4Mu"),
...
K0To4MuBPHMCMatch = cms.EDProducer(
    "MCMatcher",
    src         = K0To4MuTable.src,
    matched     = cms.InputTag("finalGenParticlesBPH"),
    mcPdgId     = cms.vint32(130, 310),
...
K0To4MuBPHMCTable = cms.EDProducer(
    "CandMCMatchTableProducerBPH",
    recoObjects = K0To4MuTable.src,
    genParts    = cms.InputTag("finalGenParticlesBPH"),
    mcMap       = cms.InputTag("K0To4MuBPHMCMatch"),
    objName     = K0To4MuTable.name,
    objType     = cms.string("Other"),
    objBranchName = cms.string("genPart"),
    genBranchName = cms.string("K0To4Mu"),
    docString   = cms.string("MC matching to status==2 4-muon resonance"),
)

########################### Sequences ###########################

K0To4MuSequence = cms.Sequence(K0To4Mu)
K0To4MuTables = cms.Sequence(K0To4MuTable)
K0To4MuMCSequence = cms.Sequence(K0To4Mu + K0To4MuBPHMCMatch)
K0To4MuMCTables = cms.Sequence(K0To4MuTable + K0To4MuBPHMCTable)
