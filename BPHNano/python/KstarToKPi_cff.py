...
KstarToPiKTable = cms.EDProducer("SimpleCandidateFlatTableProducer",
    ...
    variables = cms.PSet(
        CandVars,
        fitted_mass = Var("userFloat('fitted_mass')", float, doc="", precision=10),
        fitted_pt   = Var("userFloat('fitted_pt')", float, doc="", precision=10),
        fitted_eta  = Var("userFloat('fitted_eta')", float, doc="", precision=10),
        fitted_phi  = Var("userFloat('fitted_phi')", float, doc="", precision=10),
        svprob      = Var("userFloat('sv_prob')", float, doc="", precision=10),
        trk1_mass   = Var("userFloat('trk1_mass')", float, doc="", precision=10),
        trk2_mass   = Var("userFloat('trk2_mass')", float, doc="", precision=10),
        trk1_idx    = Var("userInt('trk1_idx')", int, doc=""),
        trk2_idx    = Var("userInt('trk2_idx')", int, doc=""),
        second_mass_hypothesis = Var("userInt('second_mass_hypothesis')", int, doc="", precision=10),
