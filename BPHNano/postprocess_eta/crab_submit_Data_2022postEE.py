...
requestName = 'BNanoPostData_2022post_Feb25'
...
config.JobType.psetName = "run_data_Run3Summer22EE.py"
#config.JobType.psetName = 'PSet.py'
config.JobType.scriptExe = 'crab_script_data.sh'
config.JobType.scriptArgs = []
config.JobType.inputFiles = ['postproc_data.py', "run_data_Run3Summer22EE.py", "crab_script_data.sh"]
...
config.Data.outLFNDirBase = '/store/group/phys_bphys/yilai/eta_2mu2pi/postprocess_v2/2022post/'
