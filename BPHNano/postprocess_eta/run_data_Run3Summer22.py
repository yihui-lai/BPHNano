...
# with command line options: step1 --fileout out_step1.root --eventcontent NANOAODSIM --datatier NANOAOD --conditions 130X_dataRun3_v2 --step NANO --scenario pp --era Run3 --nThreads 2 --python_filename run_data_Run3Summer22.py --no_exec --data
