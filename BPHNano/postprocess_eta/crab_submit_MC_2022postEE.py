...
config.JobType.psetName = "run_mc_Run3Summer22EE.py"
#config.JobType.psetName = 'PSet.py'
config.JobType.scriptExe = 'crab_script_mc.sh'
config.JobType.scriptArgs = []
config.JobType.inputFiles = ['postproc_mc.py', "run_mc_Run3Summer22EE.py", "crab_script_mc.sh"]
...
config.Data.unitsPerJob = 40000 # events
