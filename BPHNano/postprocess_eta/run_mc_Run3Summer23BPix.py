...
# with command line options: step1 --fileout out_step1.root --mc --eventcontent NANOAODSIM --datatier NANOAOD --conditions 130X_mcRun3_2023_realistic_postBPix_v6 --step NANO --scenario pp --era Run3_2023 --nThreads 2 --python_filename run_mc_Run3Summer22.py --no_exec
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:/eos/cms/store/group/phys_bphys/yilai/pluto_mc/Eta_2mu2pi/Run3Summer23BPix_MiniAODv4/260218_231843/0000/MiniAODv4_38.root'),
