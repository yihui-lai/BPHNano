...
requestName = 'BNanoPostData_2023post_Feb25'
...
config.JobType.psetName = "run_data_Run3Summer23BPix.py"
#config.JobType.psetName = 'PSet.py'
config.JobType.scriptExe = 'crab_script_data.sh'
config.JobType.scriptArgs = []
config.JobType.inputFiles = ['postproc_data.py', "run_data_Run3Summer23BPix.py", "crab_script_data.sh"]
...
config.Data.outLFNDirBase = '/store/group/phys_bphys/yilai/eta_2mu2pi/postprocess_v2/2023post/'
