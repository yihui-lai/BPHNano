...
class K0To2L2PiBuilder : public edm::global::EDProducer<> {

  // perhaps we need better structure here (begin run etc)
public:
  typedef std::vector<reco::TransientTrack> TransientTrackCollection;

  explicit K0To2L2PiBuilder(const edm::ParameterSet &cfg):
...
void K0To2L2PiBuilder::produce(edm::StreamID, edm::Event &evt, edm::EventSetup const &iSetup) const {
...
//	std::cout << "ditrack with opposite charge: "<<std::endl;
	...
	auto k0p4 = l1_p4 + l2_p4 + trk1_p4 + trk2_p4;
	cand.setP4(k0p4);
...
DEFINE_FWK_MODULE(K0To2L2PiBuilder);
